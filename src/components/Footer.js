...
{/* footer main Function from  here*/}
...
{/* footer main from here                   */}
        </div>
        <div className="footerBorder">
       <div> Copyright © 2010 - 2021 Xiaomi. All Rights Reserved Design by Md Shams Firoz</div>
        </div>
